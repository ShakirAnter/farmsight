...
export function SEOHead({
  ...
  useEffect(() => {
    ...
    try {
      ...
      const currentUrl = url || (typeof window !== 'undefined' && window.location ? window.location.href : '');
      ...
      const updateMetaTag = (property: string, content: string, isProperty: boolean = true) => {
        try {
          ...
          // Silently fail for individual meta tags
        }
      };
      ...
      const updateLinkTag = (rel: string, href: string) => {
        try {
          ...
          // Silently fail for individual link tags
        }
      };
      ...
      // Canonical URL
      updateLinkTag('canonical', currentUrl || window.location.href);
      ...
      // Silently fail for the entire effect
    }
